...
<p align="center">
  <img src="https://leventkaracan.github.io/assets/img/data_structures_course_teaser2.png" alt="Data Structures" width="80%">
</p>
...
|------|----------------|------------------------|
| 1 | C++ Basics: Syntax, Control Structures, C++ Arrays | Simple coding exercises |
| 2 | Pointers & References & Dynamic Memory Management | Dynamic array implementation |
| 3 | OOP Intro & Intro to Data Structures | Mini OOP exercise |
| 4 | Complexity &  Singly Linked List| Array vs linked list comparison |
| 5 | Doubly & Circular Linked List | Implement DLL | 
| 6 | Stacks | Undo feature simulation |
| 7 | Queues & Deques | Process scheduling simulation |
| 8 | Binary Trees | Binary tree implementation |
| 9 | Binary Search Trees & AVL Trees | BST efficiency awareness |
| 10 | Heaps & Priority Queues | Job scheduling example |
| 11 | Hashing | Implement a hash table
| 12 | Graph Basics | Simple graph exercise |
